    ...
    return (
        <header className="bg-[#ff5200] font-serif">
            <div className="flex justify-between container mx-auto py-8">
                ...
                <div className="flex text-white text-base font-bold gap-10 items-center">
                    <a target="_blank" href="https://www.swiggy.com/corporate/">Swiggy Corporate</a>
                    <a target="_blank" href="https://partner.swiggy.com/login#/swiggy">Partner with us</a>
                    <a target="_blank" href="https://partner.swiggy.com/login#/swiggy" className="border py-3 px-4 rounded-2xl">Get The App</a>
                    <a target="_blank" href="https://partner.swiggy.com/login#/swiggy" className="border-none bg-black py-3 px-4 rounded-2xl">Sign in</a>
                </div>
            </div>
            ...
            <div className="pt-16 pb-8 relative">
                ...
                <div className="max-w-[70%] container mx-auto flex gap-5 mt-10">
                    ...
                    <input className="bg-white w-[50%] text-xl px-6 py-4 rounded-2xl" placeholder="Search for resturant and items for more"></input>
                </div>
            </div>
